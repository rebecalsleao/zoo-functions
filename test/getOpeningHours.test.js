...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Verificar para os argumentos Saturday e C9:00-AM se deve lançar uma exceção com mensagem específica', () => {
    expect(() => getOpeningHours('Saturday', 'C9:00-AM')).toThrowError(new Error('The hour should represent a number'));
  });
  it('Para os argumentos Sunday e 09:c0-AM deve lançar uma exceção com mensagem específica', () => {
    expect(() => getOpeningHours('Sunday', '09:c0-AM')).toThrowError(new Error('The minutes should represent a number'));
  });
  it('Verificar para os argumentos Monday e 13:00-AM deve lançar uma exceção com mensagem específica', () => {
    expect(() => getOpeningHours('Monday', '13:00-AM')).toThrowError(new Error('The hour must be between 0 and 12'));
  });
  it('Verificar para os argumentos Tuesday e 09:60-AM deve lançar uma exceção com mensagem', () => {
